...
export class HelpView extends LitElement {
    ...
    async _loadKeybinds() {
        try {
            const keybinds = await workflowDaddy.storage.getKeybinds();
            if (keybinds) {
    ...
    render() {
        const isMacOS = workflowDaddy.isMacOS || false;
        const isLinux = workflowDaddy.isLinux || false;
            ...
            <div class="help-container">
                <div class="option-group">
                    ...
                    <div class="community-links">
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://workflowdaddy.com')}>
                        ...
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://github.com/sohzm/workflow-daddy')}>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="option-group">
                    ...
                    <div class="profiles-grid">
                        <div class="profile-item">
                            <div class="profile-name">Workflow Documentation</div>
                            <div class="profile-description">Document your job workflows, processes, tools, and decisions so an AI can learn and assist with your work</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="option-group">
                    ...
                    <div class="description">The AI interviews you about your current job, then observes your screen to document your workflows, processes, and decisions.</div>
                </div>
            </div>
        `;
    }
